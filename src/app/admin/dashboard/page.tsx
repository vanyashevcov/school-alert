...
export default function DashboardPage() {
    return (
        <div className="flex-1 pt-6 flex flex-col">
            ...
            <Tabs defaultValue="content" className="flex flex-col flex-1 pt-2">
                ...
                <TabsContent value="content" className="m-0 flex-1">
                    <ContentManager />
                </TabsContent>
                <TabsContent value="schedule" className="m-0 flex-1">
                    <BellScheduleManager />
                </TabsContent>
                <TabsContent value="news" className="m-0 flex-1">
                     <NewsTickerManager />
                </TabsContent>
            </Tabs>
        </div>
